...
include::modules/proc_Configuring_the_Hammer_CLI_to_use_FreeIPA_user_authentication.adoc[leveloffset=+1]
//include::modules/proc_configuring-a-host-to-use-IdM-credentials-to-log-in-to-the-project-hammer-cli.adoc[leveloffset=+1]
